...
RETURNING id, created_at, updated_at, name, url, user_id, user_name, last_fetched_at
`
...
SELECT id, created_at, updated_at, name, url, user_id, user_name, last_fetched_at FROM feeds
`
